...
Atlassian. (2025). State of Developer Experience 2025. ~3,500 respondents; average developer spends ~16% of the working week writing code. Cited via Orosz (2026) in support of the volume-conservation argument; figure not independently verified.
...
Orosz, G. (2026, January 6). When AI writes almost all code, what happens to software engineering? *The Pragmatic Engineer*. Source of the "writing code fast was never the bottleneck" refrain and the via-citation for Atlassian (2025). Distinct from Orosz & Nilsson (2026); exact article URL to be confirmed.
