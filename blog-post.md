...
The pattern shows up in the data systematically. He et al. (MSR'26) studied 806 GitHub repositories that adopted Cursor and tracked them over two years: cognitive complexity rose 41.6%, velocity gains were transient and fully cancelled out within months by the complexity debt they generated. METR's 2025 randomized controlled trial of experienced open-source developers found they were 19% *slower* when using AI tools — while subjectively believing they were 20% faster. The perception of productivity diverged from the measurement by nearly forty percentage points.
...
Lehman called them the laws of software evolution. By the late 1990s he had eight of them, derived from decades of empirical observation across many large systems. Five describe properties that hold whether software is written by humans, agents, or any combination. They behave like physics. Entropy increases. Comprehension caps how much change a system can absorb. Total activity rate is conserved over a system's lifetime. These are not predictions of pathology — they are descriptions of what is always true about software embedded in the real world.

What's happening with AI coding agents in 2024-2026 is exactly what Lehman's framework predicts. The empirical record from this period — 41.6% complexity increases, AI-generated debt persisting for months in production, 19% measured slowdowns alongside 20% perceived speedups, declining stability in DORA reports — reads as accelerated confirmation of theory that has held for half a century. AI doesn't break the laws. It compresses the timeline on which the consequences of ignoring them become visible.
...
This is the insight that reframes the conversation about AI productivity. If total activity is conserved, then AI cannot increase organizational output by adding capacity. The pie does not get bigger. What AI can do is change what each unit of activity *produces* — its value density.
...
**Replacement bets — likely to invert.** Klarna's 2024 AI-replaces-customer-service initiative reverted in May 2025, with the CEO publicly stating they had cut quality too far. Salesforce's 9,000-to-5,000 engineering headcount reduction partially reversed by February 2026. The framework would have predicted both. When verification capacity becomes binding, you cannot remove the verifiers and keep the output quality. The empirical record now agrees.
...
A computer scientist watching IBM's OS/360 evolve in 1974 worked out structural properties of software that explain what we see when Claude Code is pointed at a codebase in 2026. He could not have known what was coming. He didn't need to. The dynamics were already there in the structure of what software is.

The technology has changed. The conservation laws haven't.
