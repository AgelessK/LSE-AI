...
Orosz, G., & Nilsson, E. (2026). The impact of AI on software engineers in 2026: key trends (Parts 1–2). *The Pragmatic Engineer* newsletter. https://newsletter.pragmaticengineer.com/p/ai-impact-on-software-engineers-part-2 Reader survey of 900+ software engineers and engineering leaders. Cited here for the finding that senior engineers are reallocating to AI the apprenticeship-grade work previously delegated to juniors, and that less-experienced engineers are disproportionate, unproductive token spenders who find agentic tools stressful for lack of verification experience — field evidence for the verification-skill-pipeline mechanism. Self-selected, self-report sample; cited as practitioner field evidence, not a controlled study.

Appleton, M. (2026). One Developer, Two Dozen Agents, Zero Alignment. GitHub Next. https://maggieappleton.com/zero-alignment Conference talk and research-stage prototype arguing that, as AI makes implementation cheap, "agreeing on what to build" becomes the binding constraint — the intent-alignment (Loop 2) bottleneck — and demonstrating a shared multiplayer workspace that brings planning, context-gathering, and agent collaboration together so intent is established before agents act. Cited as an early, at-scale-unvalidated example of tooling targeting the alignment surface, the Loop 2 analog of the verification-floor tooling.
