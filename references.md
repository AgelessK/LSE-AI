...
Cortex. (2026). 2026 Benchmark Report. Survey of 50+ engineering leaders. Reports change failure rate — the share of deployments that cause outages or rollbacks — up 30%. Cited here via Orosz (2026) as field evidence consistent with the declining-stability signal in DORA (2024); a self-report survey, not a controlled study, and the figure has not been independently verified against the primary source.
